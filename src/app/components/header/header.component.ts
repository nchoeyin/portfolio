    ...
    <div class="text-md sm:text-3xl md:text-4xl text-black text-center font-sm">Ngawang Choeying</div>
     <section class="flex gap-4 items-center">
      ...
      <section class="md:flex gap-6 {{showMenu ? 'block' : 'hidden'}}">
        <div class="text-xs sm:text-lg md:text-2xl lg:text-3xl text-black hover:text-gray-200">
          <a href="#experience">Experience</a>
        </div>
        <div class="text-xs sm:text-xl md:text-lg lg:text-3xl text-black hover:text-gray-200">
